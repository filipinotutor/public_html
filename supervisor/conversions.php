...
$totalUnap = $page_protect->get_tutor_conversions_count($uid,"new",$filter);
$totalRec = $page_protect->get_tutor_conversions_count($uid,"disapproved",$filter);
$totalNoRec = $page_protect->get_tutor_conversions_count($uid,"",$filter);

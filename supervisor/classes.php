						...
						<div class="modal-dialog">
							<div class="modal-content">
										...
										<div class="modal-body">
											...
											// $page = 'tutor/classes.php';
											// $d = array('student_id' => $row['user_id']);
											// $data = $page_protect->get_tutor_to_student_class_history($page , $d);
											
											// $output = '<div class="container"><div class="row"><div class="col-xs-1" style="width: 150px;"><strong>Attendance</strong></div><div class="col-xs-1" style="width: 150px;"><strong>Status</strong></div><div class="col-xs-1" style="width: 150px;"><strong>Date</strong></div><div class="col-xs-1" style="width: 150px;"><strong>Time</strong></div></div>';
											// while($row = mysql_fetch_array($data)) {
											// 	$output .= '<div class="row">';
											// 	$output .= '<div class="col-xs-1" style="width: 150px;">'. $row['attendance'] . '</div>'; 
										 //        $output .= '<div class="col-xs-1" style="width: 150px;">'. $row['status'] . '</div>'; 
										 //        $output .= '<div class="col-xs-1" style="width: 150px;">'. $row['date'] . '</div>';
										 //        $output .= '<div class="col-xs-1" style="width: 150px;">'. $row['time'] .'</div>'; 
											// 	$output .= '</div>';
											// }
											// $output .= '</div>';
											// echo $output;

                ...
                <table class="table table-bordered table-striped table-hover">
                  <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                      <td>Birthday</td>
                        <td><?php echo '<a href="#"  id="birthday" data-type="combodate" data-pk="'.$tud.'" title="Click to change the tutor\'s birthday" data-value="'.$page_protect->app_birthday.'"></a>'; ?>
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tr>
                      <td width="160">Highest Educational Level</td>
                        <td><?php echo '<a href="#" id="level"  data-type="select" data-pk="'.$tud.'" data-value="'.$page_protect->app_ed_level.'" data-source="ed-levels.php" title=""></a><br>'; ?></td>
                    </tr>
                    <tr>

...
var $inject = ['$scope','$rootScope', '$stateParams', '$state', 'ApplicantSess', 'Applicant', ApplicantCtrl];


	function ApplicantCtrl($scope, $rootScope, $stateParams, $state, ApplicantSess, Applicant){
...
angular.module('filTutorApp')
	.controller('ApplicantCtrl', $inject);
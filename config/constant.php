...
require_once('../includes/web_settings_class.php');
...
define("CLASS_PATH", dirname($_SERVER['PHP_SELF'])."/includes/"); // the location where the class is executed
...
define("PROFILE_TABLE", DB_NAME.".profiles");
...
define("SUPERVISOR_PAGE", APPLICATION_PATH."supervisor/dashboard.php");

define("TUTOR_PAGE", APPLICATION_PATH."tutor/dashboard.php");

define("STUDENT_PAGE", APPLICATION_PATH."student/dashboard.php");
...
define("DENY_ACCESS_PAGE", APPLICATION_PATH."includes/deny_access.php");

define("ADMIN_PAGE", APPLICATION_PATH."admin/dashboard.php?t=8A");
...
if (USE_PHP_MAILER) include_once("class.phpmailer.php");

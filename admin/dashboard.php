...
?>
    ...
    <div class="col-md-9">
       <div class="row">
          ...
          <tbody>
            <?php
              $output = $page_protect->get_notification_list($page_protect->user_id,"AND `notification`.`process_name` = 'new student ' GROUP BY `notification`.`process_id` ORDER BY `notification`.`process_id` DESC"," LIMIT 0,20");
			 // print_r($output);
                ...
                <tr>
				  ...
				  <td><a class="btn btn-xs btn-info" href="student_profile.php?StudId='.$output[$x]['p_id'].'&t=1A" target="_blank"><i class="glyphicon-search glyphicon"></i></a></td>
				  </tr>
                ';
              }
            ?>
          ...
          <tbody>
            <?php
              $output = $page_protect->get_notification_list($page_protect->user_id,"AND `notification`.`process_name` = 'new applicant' ","");
                ...
                <tr>
				  ...
				  <td><a class="btn btn-xs btn-info" href="applicant_profile.php?AppId='.$output[$x]['p_id'].'&t=3A" target="_blank"><i class="glyphicon-search glyphicon"></i></a></td>
                </tr>
                ';
            	}
              }

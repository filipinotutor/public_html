...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>
	        <a class="btn btn-sm btn-info" ng-click="allStudent()">All ({{ studCount }})</a>
	        <a class="btn btn-sm btn-success" ng-click="newlyRegister()">New ({{ newRegCount }})</a>
	        <a class="btn btn-sm btn-warning" ng-click="deactStudent()">Deactivated ({{ deactStudCount }})</a>
        </h2>
      ...
      <div class="x_content">
        ...
        <table st-table="studentListColl" st-safe-src="studentlist" id="dataTable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
          <thead>
            <tr role="row">
          ...
          <tbody ng-repeat="s in studentListColl">
              ...
              <td>{{ s.email }}</td>
              <td>
              	<a ui-sref="student_profile({userNameOrEmail: s.username})"><span class="label label-warning">View / Edit</span></a>

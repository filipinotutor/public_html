          ...
          <div class="">
			...
			<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a href="tutors-class-upcoming.php" class="btn btn-sm btn-info">Upcoming Classes</a><a href="tutors-class-history.php" class="btn btn-sm btn-success">Class History</a></h2>

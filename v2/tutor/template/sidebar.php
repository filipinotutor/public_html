<div class="left_col scroll-view">
	...
	<div class="profile">
	  ...
	  <div class="profile_info">
		...
		<h2>Myleen DeLeon</h2>
		<br />
		<p><b>Tutor ID:</b> F3A3211
		<b>Active Students:</b> 20</p>
	  </div>
	</div>
	<!-- /menu profile quick info -->
		...
		<ul class="nav side-menu">
		  ...
		  <li><a><i class="fa fa-book"></i> My Classes <span class="fa fa-chevron-down"></span></a>
			<ul class="nav child_menu">
				...
				<li><a href="tutors-class-upcoming.php">Upcoming Classes</a></li>
				<li><a href="tutors-class-history.php">Class History</a></li>
			</ul>
		  </li>
